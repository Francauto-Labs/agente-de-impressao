...
app.post("/print", async (req, res) => {
    ...
    console.log(`🖨️ Pedido de impressão recebido: ${tipo} #${id_requisicao} → ${printer_ip}`);
    const result = await (0, printer_service_1.sendToPrinter)(file_url, printer_ip, 10000, id_requisicao);
...
app.listen(PORT, () => console.log(`🚀 Agente de Impressão rodando na porta ${PORT}`));
